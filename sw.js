const CACHE='voiceledger-0.4-beta';
const ASSETS=['./','./index.html','./styles.css?v=0.4','./app.js?v=0.4','./manifest.webmanifest','./icon-192.png?v=0.4','./icon-512.png?v=0.4','./apple-touch-icon.png?v=0.4','./favicon.png?v=0.4'];
