const CACHE='voiceledger-0.8-beta';
const ASSETS=['./','./index.html','./styles.css?v=0.8','./app.js?v=0.8','./manifest.webmanifest','./icon-192.png?v=0.8','./icon-512.png?v=0.8','./apple-touch-icon.png?v=0.8','./favicon.png?v=0.8'];
